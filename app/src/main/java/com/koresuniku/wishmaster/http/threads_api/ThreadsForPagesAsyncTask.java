...
public class ThreadsForPagesAsyncTask extends AsyncTask<Void, Void, Void> {
    private final String LOG_TAG = ThreadsForPagesAsyncTask.class.getSimpleName();
    ...
    public ThreadsForPagesAsyncTask(ThreadsActivity activity, String boardId) {
        super();
        mActivity = activity;
        mBoardId = boardId;
